...
hold on
total_score_list = zeros(10,1);
for i = 1:60
    total_score_list(i) =  t2_e_score(i,e_t,e_r,e_r_LSA);
end
scatter(1:60,total_score_list,"r*")
plot(1:60,total_score_list,"r")
xlabel("eMBB切片数")
ylabel("用户得分")
title("1000ms情况下eMBB切片数与得分的关系")
